...
class AttachGestureLayout(context: Context, layout: Int) : FrameLayout(context), MediaAttachLayoutFactory.IAttachLayout {
    ...
    class GestureListener(gestureListener: AttachGestureLayout.GestureListener) : GestureDetector.SimpleOnGestureListener() {
        var gestureListener: AttachGestureLayout.GestureListener? = gestureListener
        ...
        private var gestureState: EnumGestureState? = null
        private var w: Int? = PolyvScreenUtils.getNormalWH(context as Activity)[0]
        private var h: Int? = PolyvScreenUtils.getNormalWH(context as Activity)[1]
