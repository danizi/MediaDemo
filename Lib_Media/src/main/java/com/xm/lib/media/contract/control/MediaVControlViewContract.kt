...
class MediaVControlViewContract {
    interface View : ControlViewContract.View<MediaVControlView>

    class Model : ControlViewContract.Model()

    class Present(context: Context?, val view: View?) : ControlViewContract.Present<MediaVControlViewContract.Model>(context, Model()) {
